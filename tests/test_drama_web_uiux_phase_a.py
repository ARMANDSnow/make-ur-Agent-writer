...
class DramaWebUiuxPhaseATests(unittest.TestCase):
    ...
    def test_overview_has_six_explicit_page_states_and_recovery_hooks(self) -> None:
        ...
        self.assertIn('function dramaEpisodeFromUrl()', js)
        self.assertIn('/drama/progress?episode_no=', js)
        self.assertIn('/drama/production?episode_no=', js)
        self.assertIn('/production?episode_no=', js)
        self.assertIn('/write?episode=', js)
    ...
    def test_production_list_and_canvas_share_projection_and_keep_hooks(self) -> None:
        ...
        self.assertNotIn('data-shot-id="', js)
        ...
        self.assertIn("syncDramaEpisodeLinks(dramaEpisodeFromUrl())", js)
