...
def render_workspace_continue(name: str, workspaces: Iterable[str]) -> str:
    main = (
        ...
        '<div class="field"><label for="continue-request-limit">模型请求上限</label><input id="continue-request-limit" name="max_model_requests" type="number" min="1" max="20" value="20" aria-describedby="continue-request-limit-help"><small id="continue-request-limit-help">默认每章 20 次，整次任务最多 160 次；预算或时限也可能使任务提前停止。</small></div>'
